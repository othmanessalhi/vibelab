    ...
    <main className="bg-background">
      <div className="relative h-[60vh] min-h-[400px]">
        ...
        <div className="container mx-auto px-4 md:px-6 relative h-full flex flex-col justify-end pb-12 md:pb-20">
          <h1 className="font-headline text-3xl sm:text-5xl md:text-7xl font-bold tracking-tighter text-white">
            {service.title}
          </h1>
                ...
                <div id="pricing">
                  ...
                  <div className="border rounded-lg overflow-hidden">
                      <Table>
                          <TableHeader>
                              <TableRow>
                                  <TableHead className="w-[150px] font-bold text-sm">Features</TableHead>
                          ...
                          <TableBody>
                              {pricing.features.map((feature, index) => (
                                  <TableRow key={feature}>
                                      <TableCell className="font-medium text-xs">{feature}</TableCell>
                                      {pricing.tiers.map(tier => (
                                          <TableCell key={tier.name} className="text-center">
                                              {typeof tier.values[index] === 'boolean' ? (
                                                ...
                                                <span className="text-xs">{tier.values[index]}</span>
                                              )}
                                          </TableCell>
                                      ))}
                                  </TableRow>
                              ...
                              <TableRow>
                                  ...
                                  {pricing.tiers.map(tier => (
                                      <TableCell key={tier.name} className="text-center font-bold text-sm">
                                          {tier.price}
                                      </TableCell>
                                  ))}
                              </TableRow>
