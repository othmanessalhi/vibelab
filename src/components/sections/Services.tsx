...
export default function Services() {
  return (
    <>
      <section id="services-hero" className="h-screen flex items-center justify-center bg-background">
        <RevealImageList />
      </section>
      <section id="services-list" className="py-20 md:py-32 bg-secondary/20">
